...
public class KvValueListInsertContent implements BytesListConvertible {
    private final String kvstore;
    private final byte[] key;
    private final List<byte[]> values;

    public KvValueListInsertContent(QueryParams params) {
    ...
    public KvValueListInsertContent(String kvstore, byte[] key, List<byte[]> values) {
